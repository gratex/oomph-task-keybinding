...
import com.gratex.oomph.task.keybinding.util.KeybindingAdapterFactory;
    ...
    implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender
{
   ...
   * @generated
   */
  protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(KeybindingEditPlugin.INSTANCE,
      KeybindingPackage.eNS_URI);
  ...
  /**
   * This keeps track of the one adapter used for all {@link com.gratex.oomph.task.keybinding.KeyBindingTask} instances.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * This creates an adapter for a {@link com.gratex.oomph.task.keybinding.KeyBindingTask}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * This keeps track of the one adapter used for all {@link com.gratex.oomph.task.keybinding.KeyBindingContext} instances.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * This creates an adapter for a {@link com.gratex.oomph.task.keybinding.KeyBindingContext}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * This keeps track of the one adapter used for all {@link com.gratex.oomph.task.keybinding.CommandParameter} instances.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * This creates an adapter for a {@link com.gratex.oomph.task.keybinding.CommandParameter}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  public static class BaseChildCreationExtender implements IChildCreationExtender
  {
    ...
    protected static class CreationSwitch extends BaseSwitch<Object>
    {
      ...
      {
        newChildDescriptors.add(createChildParameter(BasePackage.Literals.ANNOTATION__CONTENTS, KeybindingFactory.eINSTANCE.createKeyBindingTask()));

        newChildDescriptors.add(createChildParameter(BasePackage.Literals.ANNOTATION__CONTENTS, KeybindingFactory.eINSTANCE.createKeyBindingContext()));

        newChildDescriptors.add(createChildParameter(BasePackage.Literals.ANNOTATION__CONTENTS, KeybindingFactory.eINSTANCE.createCommandParameter()));
  ...
  public static class SetupChildCreationExtender implements IChildCreationExtender
  {
    ...
    protected static class CreationSwitch extends SetupSwitch<Object>
    {
      ...
      {
        newChildDescriptors
            .add(createChildParameter(SetupPackage.Literals.SETUP_TASK_CONTAINER__SETUP_TASKS, KeybindingFactory.eINSTANCE.createKeyBindingTask()));
